...
-- Create List: Employee Information
SELECT emp_no,
    first_name,
last_name,
    gender
...
-- Make new temp table, add aliases and join the three tables
SELECT e.emp_no,
    e.first_name,
e.last_name,
    e.gender,
...
-- Create List: Department Retirees
-- Add department number to current_emp table
SELECT ce.emp_no,
ce.first_name,
ce.last_name,
d.dept_name
...
-- Create table only for Sales Team
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
di.dept_name
...
-- Create table only for Sales and Development Team
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
di.dept_name
INTO development_sales_dept_info
FROM retirement_info AS ri
INNER JOIN dept_info AS di
ON ri.emp_no = di.emp_no
WHERE di.dept_name IN ('Development','Sales');

SELECT * FROM development_sales_dept_info;
